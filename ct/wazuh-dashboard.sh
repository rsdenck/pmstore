...
header_info() {
  ...
  echo -e "  $RSDENCK"
  echo -e "========================================"
  echo -e "  Wazuh Dashboard 4.14.5 - Rocky Linux 9"
  echo -e "========================================"
}
...
var_disk=${var_disk:-6}
IP="192.168.130.16/24"
GW="192.168.130.1"
DNS="8.8.8.8"

header_info
echo -e "Deploying Wazuh Dashboard CT $CTID..."
...
echo -e "  $RSDENCK"
echo -e "========================================"
echo -e "  Wazuh Dashboard CT $CTID deployed!"
echo -e "  IP: ${IP%/*}"
