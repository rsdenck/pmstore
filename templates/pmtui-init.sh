...
NETCFG
  ...
  if [[ -f "$INSTALL_SCRIPT" ]]; then
    ...
    log "No install script for ${APPLIANCE} at ${INSTALL_SCRIPT}"
    echo "WARNING: No install script found for ${APPLIANCE}"
  fi
